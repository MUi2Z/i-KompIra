    <!-- Side Bar -->
        <aside id="sidebar" class="mt-2 mb-4 w-full lg:w-64 bg-[#EFE6D5] shadow-lg p-6 flex flex-col items-center text-center rounded-e-lg space-y-4">
            ...
            <a href="../admin/dashbord.php" class="w-full py-3 px-4 bg-[#D4A259] text-white font-semibold rounded-lg shadow hover:bg-[#D4A299] transition duration-200">Dashbord</a>
